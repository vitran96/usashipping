...
module.exports = async (request, response, deledate, next) => {
  ...
  try {
    ...
    if (calculation_type === 'api') {
      ...
      calculate_api = cost = weight_based_rate = weight_based_cost = null;
    } else if (calculation_type === 'weight_based_rate_v2') {
      calculate_api = cost = price_based_cost = weight_based_cost = null;
    } else if (calculation_type === 'weight_based_rate') {
      calculate_api = cost = price_based_cost = weight_based_rate = null;
    } else {
      calculate_api = weight_based_cost = weight_based_rate = price_based_cost = null;
    }
